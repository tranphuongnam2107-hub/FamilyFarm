...
namespace FamilyFarm.Tests.FriendTest
{
    public class SendFriendrequest
    {
        ...
        public async Task SendFriendRequest_ReturnsUnauthorized_WhenUsernameIsNull()
        {
            _authenticationService.Setup(x => x.GetDataFromToken())
                .Returns((UserClaimsResponseDTO)null);

            var result = await _friendController.SendFriendRequest(new CreateFriendRequestDTO { ReceiverId = "682bf676686a672acb6a6380" });
        ...
        public async Task SendFriendRequest_ReturnsOk_WhenSuccessful()
        {
            ...
            _friendRequestService.Setup(f => f.SendFriendRequestAsync("6843e30d3c4871a0339bb1a9", "682bf676686a672acb6a6380"))
                .ReturnsAsync(true);
