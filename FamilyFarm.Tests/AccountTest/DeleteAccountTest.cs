...
namespace FamilyFarm.Tests.AccountTest
{
    public class DeleteAccountTest
    {
        ...
        [Test]
        public async Task DeleteAccountByAccId_ReturnsUnauthorized_WhenAccIdIsNull()
        {
            // Arrange
        ...
        [Test]
        public async Task UpdateAccountStatus_ReturnsOk_WhenUpdateIsSuccessful()
        {
            // Arrange
            _authenticationService.Setup(x => x.GetDataFromToken())
        ...
        [Test]
        public async Task UpdateAccountStatus_ReturnsBadRequest_WhenUpdateFails()
        {
            // Arrange
            _authenticationService.Setup(x => x.GetDataFromToken())
                .Returns(new UserClaimsResponseDTO { AccId = "685660321fc7aebe254c4be1" });
